...
SINGLE = HERE.parent / "thesis-v4-mutation-tests"
...
freeze = {
    "freeze_id": "thesis-v4-multifault-preoracle-v1",
...
result = {
    "corpus_id": "thesis-v4-multifault-composition-v1",
    "cases": len(oracle),
...
(HERE / "REPORT.md").write_text(
    f"""# Thesis-v4 multi-fault composition report
